...
\begin{Desc}
\item[Vorbedingung:]Beendet die Verbindung zum Datenbankserver \end{Desc}
\begin{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Lässt den internen Zeiger auf angegebenen Datensatz der letzten Anfrage zeigen. Der Datensatz lässt sich danach mit Fetch abfragen. \end{Desc}
\begin{Desc}
\item[R\"{u}ckgabe:]Bei Erfolg true, im Fehlerfall false \end{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Wandelt aktuellen Datensatz in Objekt um und gibt ihn zurück. Nach erfolgreicher Operation wird der interne Zeiger eine Stelle weiter gerückt \end{Desc}
\begin{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Entfernt Datensätze der letzten Anfrage und gibt deren Speicher frei \end{Desc}
\begin{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Gibt Anzahl der bei der letzten INSERT, UPDATE bzw. DELETE Anweisung geänderten Datensätze \end{Desc}
\begin{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Liefert Array mit Fehlernachricht und interner Fehlernummer zurück \end{Desc}
\begin{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Gibt Anzahl der bei der letzten SELECT-Anweisung gefundenen Datensätze \end{Desc}
\begin{Desc}
\item[R\"{u}ckgabe:]Anzahl der Datensätze \end{Desc}
\begin{Desc}
...
\begin{Desc}
\item[Vorbedingung:]Sendet eine Anfrage an die aktive Datenbank. Erhaltene Datensätze der Anfrage können mit Fetch abgefragt werden \end{Desc}
\begin{Desc}
\item[Parameter:]
\begin{description}
